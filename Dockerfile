...
LABEL DefaultCMD="forever --spinSleepTime 10000 --minUptime 10000 --watchIgnore /opt/apps/node_modules/ --watchIgnore /opt/apps/public/ -w bin/www"

// Install forever js version 0.14.2 (because version 0.15.3 /latest cannot detect file change over nfs)
...
CMD ["forever","--spinSleepTime","10000","--minUptime","10000","--watchIgnore","/opt/apps/node_modules/","--watchIgnore","/opt/apps/public/","-w","bin/www"]
